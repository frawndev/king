...
if text == '' or text == '' then  
local UserId_Info = LuaTele.searchPublicChat("SOo_KING/408")
if UserId_Info.id then
local  ban = LuaTele.getUser(UserId_Info.id)
local  bain = LuaTele.getUserFullInfo(UserId_Info.id)
if  bain.bio then
...
data = {
{
{text = ' ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳', url = 't.me/SOo_KING/408'}, 
},
}
}
...
{{text = 'Delete Instagram',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"},{text = 'Delete Snapchat',url="https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount"}},{{text= ' ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳',url="https://t.me/SOo_KING/408"}}
}
local msg_id = msg.id/2097152/0.5
...
video = "https://t.me/SOo_KING/406"
local Name = '** [ ❲ ‹ 𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶 ›❳](t.me/SOo_KING/408)*\n\n* [ ❲ ‹𝚃𝙷𝙴𝚂𝚃𝚁𝙾𝙽𝙶𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙸𝙽 𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼›❳](t.me/SOo_KING/408)*\n*'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⚶𝐷𝐸𝑉 𝐾𝐼𝑁𝐺⚶',url="https://t.me/TR_E2S_ON_MY_MOoN"},{text ='⚶𝐷𝐸𝑉 𝐻𝐸𝑅𝑂⚶',url="https://t.me/H_E_R_O_V_I_P"}},
{{text = '⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶', url="https://t.me/SOo_KING/408"}},
}
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ' ❲ ‹ ⚶𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺⚶ ›❳', url = 't.me/SOo_KING/408'},},}}
